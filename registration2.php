      ...
      <form action="connect.php" method="post">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="service" name="service" value="Home Decor">
             <label for="service1"><i class="fa fa-institution"></i>Type of Service</label>
            Interior Design:<input type="radio" id="service1" name="service1" value="id">
            PVC Ceeling:<input type="radio" id="service1" name="service1" value="PVC">
            Painter:<input type="radio" id="service1" name="service1" value="painter">
            Renovation:<input type="radio" id="service1" name="service1" value="reno">
